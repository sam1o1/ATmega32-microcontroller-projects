    ...
    if ( y>5 || y<0 ){ lcd_clear();x=0; f=0; y=0; TCCR0=0; TCNT0=0; OCR0=0;}
       ...
       lcd_gotoxy(0,1);
          ...
          lcd_puts(num);
            ...
            itoa(P_S,num);
            lcd_puts(num);
     TCCR0=(1<<WGM00) | (1<<COM01) | (1<<COM00) | (1<<WGM01) | (0<<CS02) | (1<<CS01) | (0<<CS00);
     f =8000000/(P_S*(256));
       lcd_gotoxy(0,1);
        itoa (f,num);
        lcd_puts(num);
            ...
            itoa(P_S,num);
            lcd_puts(num);
TCCR0=(1<<WGM00) | (1<<COM01) | (1<<COM00) | (1<<WGM01) | (0<<CS02) | (1<<CS01) | (1<<CS00);
     f =8000000/(64*(256));
       lcd_gotoxy(0,1);
        itoa (f,num);
        lcd_puts(num);
 ...
 TCCR0=(1<<WGM00) | (1<<COM01) | (1<<COM00) | (1<<WGM01) | (1<<CS02) | (0<<CS01) | (1<<CS00);
     f = 8000000/(1024*(256));
       lcd_gotoxy(0,1);
        itoa (f,num);
        lcd_puts(num);
